                  ...
                  setTimeout(function () {
                    i.removeClass("load-more-overlay loading"),
                      Wolmart.Minipopup.open({
                        ...
                        actionTemplate:
                          '<a href="{% url \'cart\' %}" class="btn btn-rounded btn-sm">View Cart</a><a href="{% url \'checkout\' %}" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                      });
                  }, 500));
            }
          ),
    ...
    function n(e) {
      ...
      if (i.hasClass("disabled"))
        ...
        if (a.length)
          ...
          var n =
            '<div class="alert alert-success alert-cart-product mb-2">                            <a href="{% url \'cart\' %}" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' +
